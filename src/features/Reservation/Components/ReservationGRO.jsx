...
import { createReservation, getReservationBranch } from "../reservationSlice";
...
import { createCustomerGRO } from "../customerSlice";
    ...
    async (e) => {
      ...
      try {
        ...
        const customerResponse = await dispatch(
          createCustomerGRO(customerData)
        ).unwrap();

        const isExistingCustomer =
          customerResponse.message === "Phone number already exists.";
